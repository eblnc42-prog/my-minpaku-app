        ...
        <div class="info-card">
            ...
            <div style="display: flex; gap: 10px;">
                <div class="checkout-highlight" style="flex: 1;">
                    <div style="color:white; font-weight:bold;">{L["checkin_label"]}</div>
                    <div style="font-size: 2rem; font-weight: bold;">4:00 PM</div>
                </div>
                <div class="checkout-highlight" style="flex: 1;">
                    <div style="color:white; font-weight:bold;">{L["checkout_label"]}</div>
                    <div style="font-size: 2rem; font-weight: bold;">10:00 AM</div>
                </div>
            </div>
            <div class="staff-box">
                <p class="accent-blue" style="margin-bottom:5px;">{L['staff_info']}</p>
                <p style="font-size:1.1rem;">👨‍✈️ <b>Hitoshi:</b> 40資格保持/元鉄道運転士/元タクシー運転手<br>
...
with tab3:
    ...
    with c_a:
        st.markdown(f'<div class="info-card"><div class="accent-blue">{L["shops"]}</div><p><b>ライフ 大淀店 (Life)</b><br><small>Supermarket | 9:00-21:00</small></p><p><b>ファミリーマート (FamilyMart)</b><br><small>24h / ATM inside</small></p></div>', unsafe_allow_html=True)
    with c_b:
        st.markdown(f'<div class="info-card"><div class="accent-blue">{L["dining"]}</div><p><b>赤影 / 鳥欽</b><br><small>Yakitori</small></p><p><b>和光 (Wako)</b><br><small>Sushi</small></p></div>', unsafe_allow_html=True)
    ...
    st.markdown(f"""
        <div class="info-card">
            ...
            <p>🚉 <b>越部駅 / 下市口駅</b><br>
            <a href="https://www.kintetsu.co.jp/station/station_info/station16021.html" target="_blank" style="color:#00aaff; text-decoration:none; font-
